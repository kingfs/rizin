...
#define v6 (MASK_V6 | MASK_V7 | MASK_V8 | MASK_SPARCLET | MASK_SPARCLITE | MASK_V9 | MASK_V9A | MASK_V9B)
/* v6 insns not supported on the sparclet.  */
#define v6notlet (MASK_V6 | MASK_V7 | MASK_V8 | MASK_SPARCLITE | MASK_V9 | MASK_V9A | MASK_V9B)
#define v7 (MASK_V7 | MASK_V8 | MASK_SPARCLET | MASK_SPARCLITE | MASK_V9 | MASK_V9A | MASK_V9B)
...
#define v8 (MASK_V8 | MASK_SPARCLET | MASK_SPARCLITE | MASK_V9 | MASK_V9A | MASK_V9B)
...
#define v6notv9 (MASK_V6 | MASK_V7 | MASK_V8 | MASK_SPARCLET | MASK_SPARCLITE)
