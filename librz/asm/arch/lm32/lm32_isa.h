...
typedef struct rz_asm_lm32_csr_t {
	ut8 number;
	char name[RzAsmLm32RegNameLength];
} RzAsmLm32Csr;
...
typedef struct rz_asm_lm32_reg_t {
	ut8 number;
	char name[RzAsmLm32RegNameLength];
} RzAsmLm32Reg;
...
typedef enum rz_asm_lm32_instr_type_t {
	reserved,
...
typedef struct rz_asm_lm32_opcode {
...
static ut8 extract_reg_u(ut32 instr_dword) {
	return (instr_dword & RzAsmLm32RegUMask) >> RzAsmLm32RegUShift;
}

static ut8 extract_reg_v(ut32 instr_dword) {
	return (instr_dword & RzAsmLm32RegVMask) >> RzAsmLm32RegVShift;
}

static ut8 extract_reg_w(ut32 instr_dword) {
	return (instr_dword & RzAsmLm32RegWMask) >> RzAsmLm32RegWShift;
}

static ut8 extract_imm5(ut32 instr_dword) {
	return instr_dword & RzAsmLm32Imm5Mask;
}

static ut16 extract_imm16(ut32 instr_dword) {
	return instr_dword & RzAsmLm32Imm16Mask;
}
