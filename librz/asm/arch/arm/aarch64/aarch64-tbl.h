...
static const aarch64_feature_set aarch64_feature_crypto =
	AARCH64_FEATURE(AARCH64_FEATURE_CRYPTO | AARCH64_FEATURE_AES | AARCH64_FEATURE_SHA2 | AARCH64_FEATURE_SIMD | AARCH64_FEATURE_FP, 0);
...
static const aarch64_feature_set aarch64_feature_crypto_v8_2 =
	AARCH64_FEATURE(AARCH64_FEATURE_V8_2 | AARCH64_FEATURE_CRYPTO | AARCH64_FEATURE_SIMD | AARCH64_FEATURE_FP, 0);
static const aarch64_feature_set aarch64_feature_sm4 =
	AARCH64_FEATURE(AARCH64_FEATURE_V8_2 | AARCH64_FEATURE_SM4 | AARCH64_FEATURE_SIMD | AARCH64_FEATURE_FP, 0);
static const aarch64_feature_set aarch64_feature_sha3 =
	AARCH64_FEATURE(AARCH64_FEATURE_V8_2 | AARCH64_FEATURE_SHA2 | AARCH64_FEATURE_SHA3 | AARCH64_FEATURE_SIMD | AARCH64_FEATURE_FP, 0);
static const aarch64_feature_set aarch64_feature_fp_16_v8_2 =
	AARCH64_FEATURE(AARCH64_FEATURE_V8_2 | AARCH64_FEATURE_F16_FML | AARCH64_FEATURE_F16 | AARCH64_FEATURE_FP, 0);
...
struct aarch64_opcode aarch64_opcode_table[] = {
	...
	CORE_INSN("eret", 0xd69f03e0, 0xffffffff, branch_reg, 0, OP0(), { { 0 } }, 0),
	CORE_INSN("drps", 0xd6bf03e0, 0xffffffff, branch_reg, 0, OP0(), { { 0 } }, 0),
	...
	V8_3_INSN("retaa", 0xd65f0bff, 0xffffffff, branch_reg, OP0(), { { 0 } }, 0),
	V8_3_INSN("retab", 0xd65f0fff, 0xffffffff, branch_reg, OP0(), { { 0 } }, 0),
	V8_3_INSN("eretaa", 0xd69f0bff, 0xffffffff, branch_reg, OP0(), { { 0 } }, 0),
	V8_3_INSN("eretab", 0xd69f0fff, 0xffffffff, branch_reg, OP0(), { { 0 } }, 0),
	...
	/* Excep'n generation.  */
	CORE_INSN("svc", 0xd4000001, 0xffe0001f, exception, 0, OP1(EXCEPTION), { { 0 } }, 0),
	CORE_INSN("hvc", 0xd4000002, 0xffe0001f, exception, 0, OP1(EXCEPTION), { { 0 } }, 0),
	CORE_INSN("smc", 0xd4000003, 0xffe0001f, exception, 0, OP1(EXCEPTION), { { 0 } }, 0),
	CORE_INSN("brk", 0xd4200000, 0xffe0001f, exception, 0, OP1(EXCEPTION), { { 0 } }, 0),
	CORE_INSN("hlt", 0xd4400000, 0xffe0001f, exception, 0, OP1(EXCEPTION), { { 0 } }, 0),
	CORE_INSN("dcps1", 0xd4a00001, 0xffe0001f, exception, 0, OP1(EXCEPTION), { { 0 } }, F_OPD0_OPT | F_DEFAULT(0)),
	CORE_INSN("dcps2", 0xd4a00002, 0xffe0001f, exception, 0, OP1(EXCEPTION), { { 0 } }, F_OPD0_OPT | F_DEFAULT(0)),
	CORE_INSN("dcps3", 0xd4a00003, 0xffe0001f, exception, 0, OP1(EXCEPTION), { { 0 } }, F_OPD0_OPT | F_DEFAULT(0)),
	/* Extract.  */
	...
	/* System.  */
	CORE_INSN("msr", 0xd500401f, 0xfff8f01f, ic_system, 0, OP2(PSTATEFIELD, UIMM4), { { 0 } }, F_SYS_WRITE),
	CORE_INSN("hint", 0xd503201f, 0xfffff01f, ic_system, 0, OP1(UIMM7), { { 0 } }, F_HAS_ALIAS),
	CORE_INSN("nop", 0xd503201f, 0xffffffff, ic_system, 0, OP0(), { { 0 } }, F_ALIAS),
	CORE_INSN("csdb", 0xd503229f, 0xffffffff, ic_system, 0, OP0(), { { 0 } }, F_ALIAS),
	CORE_INSN("yield", 0xd503203f, 0xffffffff, ic_system, 0, OP0(), { { 0 } }, F_ALIAS),
	CORE_INSN("wfe", 0xd503205f, 0xffffffff, ic_system, 0, OP0(), { { 0 } }, F_ALIAS),
	CORE_INSN("wfi", 0xd503207f, 0xffffffff, ic_system, 0, OP0(), { { 0 } }, F_ALIAS),
	CORE_INSN("sev", 0xd503209f, 0xffffffff, ic_system, 0, OP0(), { { 0 } }, F_ALIAS),
	CORE_INSN("sevl", 0xd50320bf, 0xffffffff, ic_system, 0, OP0(), { { 0 } }, F_ALIAS),
	V8_3_INSN("xpaclri", 0xd50320ff, 0xffffffff, ic_system, OP0(), { { 0 } }, F_ALIAS),
	V8_3_INSN("pacia1716", 0xd503211f, 0xffffffff, ic_system, OP0(), { { 0 } }, F_ALIAS),
	...
	CORE_INSN("pssbb", 0xd503349f, 0xffffffff, ic_system, 0, OP0(), { { 0 } }, F_ALIAS),
	CORE_INSN("dmb", 0xd50330bf, 0xfffff0ff, ic_system, 0, OP1(BARRIER), { { 0 } }, 0),
	CORE_INSN("isb", 0xd50330df, 0xfffff0ff, ic_system, 0, OP1(BARRIER_ISB), { { 0 } }, F_OPD0_OPT | F_DEFAULT(0xF)),
	...
	V8_3_INSN("paciaz", 0xd503231f, 0xffffffff, ic_system, OP0(), { { 0 } }, F_ALIAS),
	V8_3_INSN("paciasp", 0xd503233f, 0xffffffff, ic_system, OP0(), { { 0 } }, F_ALIAS),
	V8_3_INSN("pacibz", 0xd503235f, 0xffffffff, ic_system, OP0(), { { 0 } }, F_ALIAS),
	V8_3_INSN("pacibsp", 0xd503237f, 0xffffffff, ic_system, OP0(), { { 0 } }, F_ALIAS),
	V8_3_INSN("autiaz", 0xd503239f, 0xffffffff, ic_system, OP0(), { { 0 } }, F_ALIAS),
	V8_3_INSN("autiasp", 0xd50323bf, 0xffffffff, ic_system, OP0(), { { 0 } }, F_ALIAS),
	V8_3_INSN("autibz", 0xd50323df, 0xffffffff, ic_system, OP0(), { { 0 } }, F_ALIAS),
	V8_3_INSN("autibsp", 0xd50323ff, 0xffffffff, ic_system, OP0(), { { 0 } }, F_ALIAS),
	...
	_SVE_INSN("ldr", 0x85800000, 0xffc0e010, sve_misc, 0, OP2(SVE_Pt, SVE_ADDR_RI_S9xVL), { { 0 } }, 0, 0),
	_SVE_INSN("ldr", 0x85804000, 0xffc0e000, sve_misc, 0, OP2(SVE_Zt, SVE_ADDR_RI_S9xVL), { { 0 } }, 0, 0),
	...
	_SVE_INSN("movprfx", 0x0420bc00, 0xfffffc00, sve_misc, 0, OP2(SVE_Zd, SVE_Zn), { { 0 } }, 0, 0),
	...
	_SVE_INSN("prfb", 0x8400c000, 0xffe0e010, sve_misc, 0, OP3(SVE_PRFOP, SVE_Pg3, SVE_ADDR_RX), { { 0 } }, 0, 0),
	...
	_SVE_INSN("prfb", 0x85c00000, 0xffc0e010, sve_misc, 0, OP3(SVE_PRFOP, SVE_Pg3, SVE_ADDR_RI_S6xVL), { { 0 } }, 0, 0),
	...
	_SVE_INSN("prfd", 0x8580c000, 0xffe0e010, sve_misc, 0, OP3(SVE_PRFOP, SVE_Pg3, SVE_ADDR_RX_LSL3), { { 0 } }, 0, 0),
	...
	_SVE_INSN("prfd", 0x85c06000, 0xffc0e010, sve_misc, 0, OP3(SVE_PRFOP, SVE_Pg3, SVE_ADDR_RI_S6xVL), { { 0 } }, 0, 0),
	...
	_SVE_INSN("prfh", 0x8480c000, 0xffe0e010, sve_misc, 0, OP3(SVE_PRFOP, SVE_Pg3, SVE_ADDR_RX_LSL1), { { 0 } }, 0, 0),
	...
	_SVE_INSN("prfh", 0x85c02000, 0xffc0e010, sve_misc, 0, OP3(SVE_PRFOP, SVE_Pg3, SVE_ADDR_RI_S6xVL), { { 0 } }, 0, 0),
	...
	_SVE_INSN("prfw", 0x8500c000, 0xffe0e010, sve_misc, 0, OP3(SVE_PRFOP, SVE_Pg3, SVE_ADDR_RX_LSL2), { { 0 } }, 0, 0),
	...
	_SVE_INSN("prfw", 0x85c04000, 0xffc0e010, sve_misc, 0, OP3(SVE_PRFOP, SVE_Pg3, SVE_ADDR_RI_S6xVL), { { 0 } }, 0, 0),
	...
	_SVE_INSN("setffr", 0x252c9000, 0xffffffff, sve_misc, 0, OP0(), { { 0 } }, 0, 0),
	...
	_SVE_INSN("str", 0xe5800000, 0xffc0e010, sve_misc, 0, OP2(SVE_Pt, SVE_ADDR_RI_S9xVL), { { 0 } }, 0, 0),
	_SVE_INSN("str", 0xe5804000, 0xffc0e000, sve_misc, 0, OP2(SVE_Zt, SVE_ADDR_RI_S9xVL), { { 0 } }, 0, 0),
	...
	V8_4_INSN("cfinv", 0xd500401f, 0xffffffff, ic_system, OP0(), { { 0 } }, 0),
