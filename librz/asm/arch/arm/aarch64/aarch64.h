...
#define AARCH64_ARCH_V8_1 AARCH64_FEATURE(AARCH64_ARCH_V8, \
	AARCH64_FEATURE_CRC | AARCH64_FEATURE_V8_1 | AARCH64_FEATURE_LSE | AARCH64_FEATURE_PAN | AARCH64_FEATURE_LOR | AARCH64_FEATURE_RDMA)
#define AARCH64_ARCH_V8_2 AARCH64_FEATURE(AARCH64_ARCH_V8_1, \
	AARCH64_FEATURE_V8_2 | AARCH64_FEATURE_RAS)
#define AARCH64_ARCH_V8_3 AARCH64_FEATURE(AARCH64_ARCH_V8_2, \
	AARCH64_FEATURE_V8_3 | AARCH64_FEATURE_RCPC | AARCH64_FEATURE_COMPNUM)
#define AARCH64_ARCH_V8_4 AARCH64_FEATURE(AARCH64_ARCH_V8_3, \
	AARCH64_FEATURE_V8_4 | AARCH64_FEATURE_DOTPROD | AARCH64_FEATURE_F16_FML)
...
opcode_has_special_coder(const aarch64_opcode *opcode) {
	return (opcode->flags & (F_SF | F_LSE_SZ | F_SIZEQ | F_FPTYPE | F_SSIZE | F_T | F_GPRSIZE_IN_Q | F_LDS_SIZE | F_MISC | F_N | F_COND)) ? TRUE
																	      : FALSE;
}
