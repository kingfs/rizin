...
ARC_CGEN_EXTRACT_FN(CGEN_CPU_DESC cd, const CGEN_INSN *insn,
	...
	if (!initialized) {
		static CGEN_KEYWORD_ENTRY arc_cgen_opval_limm_entry0 = { arc_limm_str, 62, { 0, { { { 0, 0 } } } }, 0, 0 };
		static CGEN_KEYWORD_ENTRY arc_cgen_opval_limm_entry1 = { arc_limm_str, 62, { 0, { { { 0, 0 } } } }, 0, 0 };
	...
	((cd)->extract_handlers[(insn)->opcode->handlers.extract](cd, insn, info, insn_value, fields, pc));
