...
extern int hexagon_encode_operand(const hexagon_operand *, hexagon_insn *, const hexagon_opcode *,
	long, long *, int, int, char **);
extern const hexagon_operand *hexagon_lookup_operand(const char *);
extern const hexagon_operand *hexagon_lookup_reloc(bfd_reloc_code_real_type, int, const hexagon_opcode *);
extern int hexagon_extract_operand(const hexagon_operand *, hexagon_insn, bfd_vma, char *, int *, char **);
extern int hexagon_extract_predicate_operand(const hexagon_operand *, hexagon_insn, char *, int *, char **);
extern int hexagon_extract_modifier_operand(const hexagon_operand *, hexagon_insn, char *, int *, char **);
extern char *hexagon_dis_operand(const hexagon_operand *, hexagon_insn, bfd_vma, bfd_vma, char *, char *, char **);
extern int hexagon_dis_opcode(char *, hexagon_insn, bfd_vma, const hexagon_opcode *, char **);
...
extern const hexagon_operand *hexagon_operand_find(const hexagon_operand *, const char *);
