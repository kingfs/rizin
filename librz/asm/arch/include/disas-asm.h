...
extern int buffer_read_memory(bfd_vma, bfd_byte *, unsigned int, struct disassemble_info *);
...
/* Also always true.  */
extern bfd_boolean generic_symbol_is_valid(asymbol *, struct disassemble_info *);
