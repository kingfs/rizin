...
RELOC_NUMBER(RZ_XTENSA_NONE, 0)
RELOC_NUMBER(RZ_XTENSA_32, 1)
RELOC_NUMBER(RZ_XTENSA_RTLD, 2)
RELOC_NUMBER(RZ_XTENSA_GLOB_DAT, 3)
RELOC_NUMBER(RZ_XTENSA_JMP_SLOT, 4)
RELOC_NUMBER(RZ_XTENSA_RELATIVE, 5)
RELOC_NUMBER(RZ_XTENSA_PLT, 6)
RELOC_NUMBER(RZ_XTENSA_OP0, 8)
RELOC_NUMBER(RZ_XTENSA_OP1, 9)
RELOC_NUMBER(RZ_XTENSA_OP2, 10)
RELOC_NUMBER(RZ_XTENSA_ASM_EXPAND, 11)
RELOC_NUMBER(RZ_XTENSA_ASM_SIMPLIFY, 12)
RELOC_NUMBER(RZ_XTENSA_32_PCREL, 14)
RELOC_NUMBER(RZ_XTENSA_GNU_VTINHERIT, 15)
RELOC_NUMBER(RZ_XTENSA_GNU_VTENTRY, 16)
RELOC_NUMBER(RZ_XTENSA_DIFF8, 17)
RELOC_NUMBER(RZ_XTENSA_DIFF16, 18)
RELOC_NUMBER(RZ_XTENSA_DIFF32, 19)
RELOC_NUMBER(RZ_XTENSA_SLOT0_OP, 20)
RELOC_NUMBER(RZ_XTENSA_SLOT1_OP, 21)
RELOC_NUMBER(RZ_XTENSA_SLOT2_OP, 22)
RELOC_NUMBER(RZ_XTENSA_SLOT3_OP, 23)
RELOC_NUMBER(RZ_XTENSA_SLOT4_OP, 24)
RELOC_NUMBER(RZ_XTENSA_SLOT5_OP, 25)
RELOC_NUMBER(RZ_XTENSA_SLOT6_OP, 26)
RELOC_NUMBER(RZ_XTENSA_SLOT7_OP, 27)
RELOC_NUMBER(RZ_XTENSA_SLOT8_OP, 28)
RELOC_NUMBER(RZ_XTENSA_SLOT9_OP, 29)
RELOC_NUMBER(RZ_XTENSA_SLOT10_OP, 30)
RELOC_NUMBER(RZ_XTENSA_SLOT11_OP, 31)
RELOC_NUMBER(RZ_XTENSA_SLOT12_OP, 32)
RELOC_NUMBER(RZ_XTENSA_SLOT13_OP, 33)
RELOC_NUMBER(RZ_XTENSA_SLOT14_OP, 34)
RELOC_NUMBER(RZ_XTENSA_SLOT0_ALT, 35)
RELOC_NUMBER(RZ_XTENSA_SLOT1_ALT, 36)
RELOC_NUMBER(RZ_XTENSA_SLOT2_ALT, 37)
RELOC_NUMBER(RZ_XTENSA_SLOT3_ALT, 38)
RELOC_NUMBER(RZ_XTENSA_SLOT4_ALT, 39)
RELOC_NUMBER(RZ_XTENSA_SLOT5_ALT, 40)
RELOC_NUMBER(RZ_XTENSA_SLOT6_ALT, 41)
RELOC_NUMBER(RZ_XTENSA_SLOT7_ALT, 42)
RELOC_NUMBER(RZ_XTENSA_SLOT8_ALT, 43)
RELOC_NUMBER(RZ_XTENSA_SLOT9_ALT, 44)
RELOC_NUMBER(RZ_XTENSA_SLOT10_ALT, 45)
RELOC_NUMBER(RZ_XTENSA_SLOT11_ALT, 46)
RELOC_NUMBER(RZ_XTENSA_SLOT12_ALT, 47)
RELOC_NUMBER(RZ_XTENSA_SLOT13_ALT, 48)
RELOC_NUMBER(RZ_XTENSA_SLOT14_ALT, 49)
RELOC_NUMBER(RZ_XTENSA_TLSDESC_FN, 50)
RELOC_NUMBER(RZ_XTENSA_TLSDESC_ARG, 51)
RELOC_NUMBER(RZ_XTENSA_TLS_DTPOFF, 52)
RELOC_NUMBER(RZ_XTENSA_TLS_TPOFF, 53)
RELOC_NUMBER(RZ_XTENSA_TLS_FUNC, 54)
RELOC_NUMBER(RZ_XTENSA_TLS_ARG, 55)
RELOC_NUMBER(RZ_XTENSA_TLS_CALL, 56)
END_RELOC_NUMBERS(RZ_XTENSA_max)
