...
RELOC_NUMBER(RZ_MIPS_NONE, 0)
RELOC_NUMBER(RZ_MIPS_16, 1)
RELOC_NUMBER(RZ_MIPS_32, 2) /* In Elf 64: alias RZ_MIPS_ADD */
RELOC_NUMBER(RZ_MIPS_REL32, 3) /* In Elf 64: alias RZ_MIPS_REL */
RELOC_NUMBER(RZ_MIPS_26, 4)
RELOC_NUMBER(RZ_MIPS_HI16, 5)
RELOC_NUMBER(RZ_MIPS_LO16, 6)
RELOC_NUMBER(RZ_MIPS_GPREL16, 7) /* In Elf 64: alias RZ_MIPS_GPREL */
RELOC_NUMBER(RZ_MIPS_LITERAL, 8)
RELOC_NUMBER(RZ_MIPS_GOT16, 9) /* In Elf 64: alias RZ_MIPS_GOT */
RELOC_NUMBER(RZ_MIPS_PC16, 10)
RELOC_NUMBER(RZ_MIPS_CALL16, 11) /* In Elf 64: alias RZ_MIPS_CALL */
RELOC_NUMBER(RZ_MIPS_GPREL32, 12)
/* The remaining relocs are defined on Irix, although they are not
     in the MIPS ELF ABI.  */
RELOC_NUMBER(RZ_MIPS_UNUSED1, 13)
RELOC_NUMBER(RZ_MIPS_UNUSED2, 14)
RELOC_NUMBER(RZ_MIPS_UNUSED3, 15)
RELOC_NUMBER(RZ_MIPS_SHIFT5, 16)
RELOC_NUMBER(RZ_MIPS_SHIFT6, 17)
RELOC_NUMBER(RZ_MIPS_64, 18)
RELOC_NUMBER(RZ_MIPS_GOT_DISP, 19)
RELOC_NUMBER(RZ_MIPS_GOT_PAGE, 20)
RELOC_NUMBER(RZ_MIPS_GOT_OFST, 21)
RELOC_NUMBER(RZ_MIPS_GOT_HI16, 22)
RELOC_NUMBER(RZ_MIPS_GOT_LO16, 23)
RELOC_NUMBER(RZ_MIPS_SUB, 24)
RELOC_NUMBER(RZ_MIPS_INSERT_A, 25)
RELOC_NUMBER(RZ_MIPS_INSERT_B, 26)
RELOC_NUMBER(RZ_MIPS_DELETE, 27)
RELOC_NUMBER(RZ_MIPS_HIGHER, 28)
RELOC_NUMBER(RZ_MIPS_HIGHEST, 29)
RELOC_NUMBER(RZ_MIPS_CALL_HI16, 30)
RELOC_NUMBER(RZ_MIPS_CALL_LO16, 31)
RELOC_NUMBER(RZ_MIPS_SCN_DISP, 32)
RELOC_NUMBER(RZ_MIPS_REL16, 33)
RELOC_NUMBER(RZ_MIPS_ADD_IMMEDIATE, 34)
RELOC_NUMBER(RZ_MIPS_PJUMP, 35)
RELOC_NUMBER(RZ_MIPS_RELGOT, 36)
RELOC_NUMBER(RZ_MIPS_JALR, 37)
/* TLS relocations.  */
RELOC_NUMBER(RZ_MIPS_TLS_DTPMOD32, 38)
RELOC_NUMBER(RZ_MIPS_TLS_DTPREL32, 39)
RELOC_NUMBER(RZ_MIPS_TLS_DTPMOD64, 40)
RELOC_NUMBER(RZ_MIPS_TLS_DTPREL64, 41)
RELOC_NUMBER(RZ_MIPS_TLS_GD, 42)
RELOC_NUMBER(RZ_MIPS_TLS_LDM, 43)
RELOC_NUMBER(RZ_MIPS_TLS_DTPREL_HI16, 44)
RELOC_NUMBER(RZ_MIPS_TLS_DTPREL_LO16, 45)
RELOC_NUMBER(RZ_MIPS_TLS_GOTTPREL, 46)
RELOC_NUMBER(RZ_MIPS_TLS_TPREL32, 47)
RELOC_NUMBER(RZ_MIPS_TLS_TPREL64, 48)
RELOC_NUMBER(RZ_MIPS_TLS_TPREL_HI16, 49)
RELOC_NUMBER(RZ_MIPS_TLS_TPREL_LO16, 50)
RELOC_NUMBER(RZ_MIPS_GLOB_DAT, 51)
FAKE_RELOC(RZ_MIPS_max, 52)
/* These relocs are used for the mips16.  */
FAKE_RELOC(RZ_MIPS16_min, 100)
RELOC_NUMBER(RZ_MIPS16_26, 100)
RELOC_NUMBER(RZ_MIPS16_GPREL, 101)
RELOC_NUMBER(RZ_MIPS16_GOT16, 102)
RELOC_NUMBER(RZ_MIPS16_CALL16, 103)
RELOC_NUMBER(RZ_MIPS16_HI16, 104)
RELOC_NUMBER(RZ_MIPS16_LO16, 105)
FAKE_RELOC(RZ_MIPS16_max, 106)
/* These relocations are specific to VxWorks.  */
RELOC_NUMBER(RZ_MIPS_COPY, 126)
RELOC_NUMBER(RZ_MIPS_JUMP_SLOT, 127)
...
RELOC_NUMBER(RZ_MIPS_PC32, 248)
/* FIXME: this relocation is used internally by gas.  */
RELOC_NUMBER(RZ_MIPS_GNU_REL16_S2, 250)
/* These are GNU extensions to enable C++ vtable garbage collection.  */
RELOC_NUMBER(RZ_MIPS_GNU_VTINHERIT, 253)
RELOC_NUMBER(RZ_MIPS_GNU_VTENTRY, 254)
END_RELOC_NUMBERS(RZ_MIPS_maxext)
...
extern void bfd_mips_elf32_swap_reginfo_in(bfd *, const Elf32_External_RegInfo *, Elf32_RegInfo *);
extern void bfd_mips_elf32_swap_reginfo_out(bfd *, const Elf32_RegInfo *, Elf32_External_RegInfo *);
...
/* The 64-bit MIPS ELF ABI uses an unusual reloc format.  Each
   ...
   uses the symbol in the rz_sym field.  The second relocation which
   requires a symbol uses the symbol in the rz_ssym field.  If all
...
/* Values found in the rz_ssym field of a relocation entry.  */
...
extern void bfd_mips_elf_swap_options_in(bfd *, const Elf_External_Options *, Elf_Internal_Options *);
extern void bfd_mips_elf_swap_options_out(bfd *, const Elf_Internal_Options *, Elf_External_Options *);
...
/* MIPS ELF reginfo swapping routines.  */
extern void bfd_mips_elf64_swap_reginfo_in(bfd *, const Elf64_External_RegInfo *, Elf64_Internal_RegInfo *);
extern void bfd_mips_elf64_swap_reginfo_out(bfd *, const Elf64_Internal_RegInfo *, Elf64_External_RegInfo *);
