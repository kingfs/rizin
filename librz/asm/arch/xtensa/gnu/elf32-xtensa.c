...
#define IS_XTENSA_TLS_RELOC(RZ_TYPE) \
	((RZ_TYPE) == RZ_XTENSA_TLSDESC_FN || (RZ_TYPE) == RZ_XTENSA_TLSDESC_ARG || (RZ_TYPE) == RZ_XTENSA_TLS_DTPOFF || (RZ_TYPE) == RZ_XTENSA_TLS_TPOFF || (RZ_TYPE) == RZ_XTENSA_TLS_FUNC || (RZ_TYPE) == RZ_XTENSA_TLS_ARG || (RZ_TYPE) == RZ_XTENSA_TLS_CALL)
