...
/* The CRzFS field in an X form instruction.  */
#define CRzFS (CRB + 1)
...
const unsigned int num_powerpc_operands = (sizeof(powerpc_operands) / sizeof(powerpc_operands[0]));
...
#define XX3DM(op, xop, dm) (XX3(op, ((unsigned long)(xop)&0x1f)) | ((((unsigned long)(dm)) & 0x3) << 8))
...
#define XRTRA(op, xop, rt, ra) (X((op), (xop)) | ((((unsigned long)(rt)) & 0x1f) << 21) | ((((unsigned long)(ra)) & 0x1f) << 16))
...
#define XFXM(op, xop, fxm, p4) \
	(X((op), (xop)) | ((((unsigned long)(fxm)) & 0xff) << 12) | ((unsigned long)(p4) << 20))
...
const struct powerpc_opcode powerpc_opcodes[] = {
	...
	{ "evsel", EVSEL(4, 79), EVSEL_MASK, PPCSPE, { RS, RA, RB, CRzFS } },
